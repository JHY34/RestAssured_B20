...
// Hamcrest assertion library already part of our Rest-Assured dependencies in pom file no separate dependencies needed

public class HamcrestMatchersTest {
    // this is a assetion library
    // Advantages:
    ...
    public void test1() {
        ...
        // not is another matcher
        assertThat("Wrong Result", 1+3, not(5));

        // we can nest a matcher inside another matcher
        assertThat("Wrong Result", 1+3, is(not(5)));

        assertThat("Wrong Result", 1+3, not(equalTo(5)));

        // test 1+3 is less than 5
        assertThat(1+3, lessThan(5));


        // test 1+3 is more than 3
