package day02;
// we are going to use below import statements ALWAYS then just COPY and PASTE
...
public class SingleSpartanTest {
    ...
    @DisplayName("Testing GET /spartan/{id} end-point")
    @Test
    public void test1Spartan() {

        // I want to get json result out
        // When I send GET result to /spartans/{id} endpoint
        // and expecting 200 status code

        // given() is not necessary because we are expecting GET value
        // but if we need to write we can
        // given().accept(ContentType.JSON)

        when().get("/spartans/100").
