...
public class Spartan_E2E_HappyPath {
    ...
    newID =
        given()
                .auth().basic("admin" , "admin")  // we can also add username and password from the configuration properties as well
                .contentType(ContentType.JSON)
                .body(  SpartanUtil.getRandomSpartanRequestPayload()  )   // By this method we wi able to add random spartan
                .log().all().
        when()
                .post("/spartans").
        then()
